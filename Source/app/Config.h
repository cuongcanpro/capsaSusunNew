...
public:
	...
	static int PORT_PRIVATE;

	static std::string SERVER_QC;
	static int PORT_QC;
	...
	static std::string MAX_MEXICO;
	static std::string MAX_VIETNAM;

	static std::string COUNTRY_MX;   // mexico
	static std::string COUNTRY_GLOBAL;   // global
	
	static std::string CHEAT_SAVE_SERVER_IP;
	static std::string CHEAT_SAVE_SERVER_PORT;

	static std::string CHEAT_SAVE_DEVICE_ID;
};
#endif // Config_h__
